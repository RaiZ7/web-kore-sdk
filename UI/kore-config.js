(function(KoreSDK){
    ...
    botOptions.JWTUrl =  "http://localhost:3000/";
    botOptions.userIdentity = "zuby.rai@csdental.com";// Provide users email id here
    botOptions.botInfo = { name: "Meddie app", _id: "st-208008dc-9418-5233-bf9c-696371412b58" }; // bot name is case sensitive
    ...
    **/
    botOptions.clientId = "st-208008dc-9418-5233-bf9c-696371412b58";
    botOptions.clientSecret = "WoSK8wYcEd0wX5/CXid0LdlhPqnTIyLGKWPc1TKqxr4=";
